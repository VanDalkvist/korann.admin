...
(function (T, $, p) {
    ...
    function ub(b, a, c) {
        var d = ba(b, "data"), e = s(c), g = !e && s(a), h = g && !J(a);
        !d && !h && ba(b, "data", d = {});
            ...
            "$http", "$templateCache", "$parse", "$controller", "$rootScope", function (b, i, j, k, l, n, r, o) {
                ...
                function fa(a, b, c, f) {
                    ...
                    switch (a.nodeType) {
                        case 1:
                            ...
                            var i, n, k;
                            j = a.attributes;
                            for (var l = 0, o = j && j.length; l < o; l++)if (i = j[l], i.specified)n = i.name, k = da(n.toLowerCase()), g[k] = n, c[k] = i = Q(Y && n == "href" ? decodeURIComponent(a.getAttribute(n, 2)) : i.value), yb(a, k) && (c[k] = !0), W(a, b, i, k), y(b, k, "A", f);
                            a = a.className;
                            if (G(a))for (; j = e.exec(a);)k = da(j[2]), y(b, k, "C", f) && (c[k] = Q(j[3])), a = a.substr(j.index + j[0].length);
                            break;
                        case 3:
                            F(b, a.nodeValue);
                            break;
                ...
                function A(a, b, c, d, e) {
                    ...
                    for (var l = -Number.MAX_VALUE, o = [], t = [], A = null, y = null, H = null, F = c.$$element = u(b), E, W, Z, x, v = d, s, D, B, C = 0, I = a.length; C < I; C++) {
                        ...
                        if (B = E.template)if (N("template", H, E, F), H = E, Z = u("<div>" + Q(B) + "</div>").contents(), b = Z[0], E.replace) {
                            if (Z.length !=
                        ...
                        if (E.templateUrl)N("template", H, E, F), H = E, k = V(a.splice(C, a.length - C), k, F, c, e, E.replace, v), I = a.length; else if (E.compile)try {
    ...
    function ua(b, a) {
        var c = Fb.exec(b), c = {protocol: c[1], host: c[3], port: I(c[5]) || Gb[c[1]] || null, path: c[6] || "/", search: c[8], hash: c[10]};
    ...
    function Lc(b, a, c, d) {
        ...
        var V = B(0), H, N = Jc(b, d), F = function () {
            var a = r(), c, d;
                ...
                do {
                    ...
                    do {
                        ...
                        if (h = t.$$watchers)for (o = h.length; o--;)try {
                            if (a = h[o], (d = a.get(t)) !== (e = a.last) && !(a.eq ? ea(d, e) : typeof d == "number" && typeof e == "number" && isNaN(d) && isNaN(e)))m = !0, a.last = a.eq ? U(d) : d, a.fn(d, e === f ? d : e, t), q < 5 && (A = 4 - q, p[A] || (p[A] = []), y = M(a.exp) ? "fn: " + (a.exp.name || a.exp.toString()) : a.exp, y += "; newVal: " + aa(d) + "; oldVal: " + aa(e), p[A].push(y))
                        } catch (V) {
                            c(V)
                        }
    ...
    function Sc() {
        this.$get = ["$window",
            function (b) {
                var a = {}, c = I((/android (\d+)/.exec(C(b.navigator.userAgent)) || [])[1]);
    ...
    function Qa(b, a, c, d, e, g) {
        ...
        i && (i.match(/^\/(.*)\/$/) ? (i = RegExp(i.substr(1, i.length - 2)), e = function (a) {
            ...
            d.$parsers.push(e));
        if (c.ngMinlength) {
            var k = I(c.ngMinlength), e = function (a) {
        ...
        if (c.ngMaxlength) {
            var l = I(c.ngMaxlength), c = function (a) {
    ...
    }, z = T.Error, Y = I((/msie (\d+)/.exec(C(navigator.userAgent)) || [])[1]), u, ha, ga = [].slice, Ra = [].push, Sa = Object.prototype.toString, Yb = T.angular || (T.angular = {}), sa, Cb, X = ["0", "0", "0"];
    x.$inject = [];
    ya.$inject = [];
    Cb = Y < 9 ? function (b) {
        b =
    ...
    var jc = /[A-Z]/g, hd = {full: "1.0.0", major: 1, minor: 0, dot: 0, codeName: "temporal-domination"}, Ba = P.cache = {}, Aa = P.expando = "ng-" + (new Date).getTime(), nc = 1, id = T.document.addEventListener ? function (b, a, c) {
    ...
    var Ed = R(function (a, c, d) {
        ...
        return{restrict: "E", require: ["select", "?ngModel"], controller: ["$element", "$scope", "$attrs", function (a, c, d) {
            ...
            if (i[1]) {
                for (var n = i[0], r = i[1], o = f.multiple, w = f.ngOptions, q = !1, t, D = u($.createElement("option")), A = u($.createElement("optgroup")), y = D.clone(), i = 0, x = h.children(), B = x.length; i < B; i++)if (x[i].value == "") {
                    t = q =
                        x.eq(i);
                    break
                }
    ...
    Yb.element = u;
    (function (a) {
        D(a, {bootstrap: ob, copy: U, extend: D, equals: ea, element: u, forEach: m, injector: pb, noop: x,
            bind: Va, toJson: aa, fromJson: mb, identity: ya, isUndefined: v, isDefined: s, isString: G, isFunction: M, isObject: J, isNumber: va, isElement: ec, isArray: K, version: hd, isDate: ma, lowercase: C, uppercase: la, callbacks: {counter: 0}});
        sa = kc(T);
        try {
            sa("ngLocale")
        } catch (c) {
        ...
        sa("ng", ["ngLocale"], ["$provide", function (a) {
            a.provider("$compile", Bb).directive({a: jd, input: ac, textarea: ac, form: kd, script: Sd, select: Ud, style: Wd, option: Vd, ngBind: vd, ngBindHtmlUnsafe: xd, ngBindTemplate: wd, ngClass: yd, ngClassEven: Ad,
                ngClassOdd: zd, ngCsp: Dd, ngCloak: Bd, ngController: Cd, ngForm: ld, ngHide: Ld, ngInclude: Fd, ngInit: Gd, ngNonBindable: Hd, ngPluralize: Id, ngRepeat: Jd, ngShow: Kd, ngSubmit: Ed, ngStyle: Md, ngSwitch: Nd, ngSwitchWhen: Od, ngSwitchDefault: Pd, ngOptions: Td, ngView: Rd, ngTransclude: Qd, ngModel: qd, ngList: sd, ngChange: rd, required: bc, ngRequired: bc, ngValue: ud}).directive(jb).directive(cc);
            a.provider({$anchorScroll: tc, $browser: vc, $cacheFactory: wc, $controller: Ac, $document: Bc, $exceptionHandler: Cc, $filter: Pb, $interpolate: Dc, $http: Uc, $httpBackend: Vc,
                $location: Hc, $log: Ic, $parse: Mc, $route: Pc, $routeParams: Qc, $rootScope: Rc, $q: Nc, $sniffer: Sc, $templateCache: xc, $timeout: Zc, $window: Tc})
        }])
    })(Yb);
    u($).ready(function () {
        ic($, ob)
