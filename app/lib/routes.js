...
module.exports = function (app, userController, todoController, apiController) {
...
//    app.post('/user/logout', userController.kill);
     ...
     */
//    app.get('/api/Todo', ensureAuthenticated, todoController.preSearch, apiController.read);
...
//    app.del('/api/Todo/:id', ensureAuthenticated, todoController.preDestroy, apiController.delete);
...
//    app.get('/api/:model/:id', ensureAuthenticated, apiController.get);
//    app.post('/api/:model/:id', ensureAuthenticated, apiController.update);
//    app.del('/api/:model/:id', ensureAuthenticated, apiController.delete);
    ...
    app.get('/', renderIndex);
    app.get('/partials/:name', renderPartials);
...
//        if (req.isAuthenticated()) { // todo: replace own logic
//            return next();
//        }
//        res.send(401)
    }
    ...
    function renderPartials(req, res) {
        ...
        res.render(app.locals.public + '/partials/' + name);
    }
};