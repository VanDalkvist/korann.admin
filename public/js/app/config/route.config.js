(function () {
    ...
    angular
        .module('korann.config.routes')
        .config(_configRoutes);

    _configRoutes.$inject = ['$locationProvider', '$stateProvider', '$urlRouterProvider'];

    function _configRoutes($locationProvider, $stateProvider, $urlRouterProvider) {
